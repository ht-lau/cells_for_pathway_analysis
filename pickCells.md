...
This is for an R01 application. We want to study cellular signaling using proteomics. The idea is that current knowledge about signaling is very â€œfuzzyâ€ due to overlapping of signaling components between pathways, e.g. both EGFR and FGFR signal through the MAPK signaling cascade.
...
With the method figured out, I downloaded the data of 11 signaling pathways from the reactome.org to expand the targets that we can study.
...
![](pickCells_files/figure-markdown_github/unnamed-chunk-1-1.png)
...
And there are 259 cell lines from 23 tissue types ![](pickCells_files/figure-markdown_github/plotting%20cells%20data-1.png)
